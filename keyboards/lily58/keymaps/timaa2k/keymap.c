...
KC_Z,     KC_X,   KC_C,    KC_V,    KC_B,    RAISE,  KC_LBRC, KC_RBRC, RAISE,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
                      KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL,           KC_ENT,  KC_SPC,  KC_BSPC, KC_EQL
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
