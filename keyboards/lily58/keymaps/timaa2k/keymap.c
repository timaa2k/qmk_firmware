 ...
 * |------+------+------+------+------+------|   [   |    |    ]  |------+------+------+------+------+------|
 * |RAISE |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|RAISE |   N  |   M  |   ,  |   .  |   /  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI |LCTRL |LShift| / LAlt  /       \Enter \  |Space |BackSP|  =   |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
...
KC_TAB,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                     KC_BSLS, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,
KC_ESC,   KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_QUOT, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,
RAISE,    KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_LBRC, KC_RBRC,  RAISE,   KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
                      KC_LGUI, KC_LCTL, KC_LSFT, KC_LALT,           KC_ENT,  KC_SPC,  KC_BSPC, KC_EQL
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 ...
 * |      |      |      |      |      |      |-------|    |-------|      |      |      |      |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LGUI | LAlt |LShift| /LCTRL  /       \Enter \  |Space |BackSP|  =   |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
[_LOWER] = LAYOUT(
